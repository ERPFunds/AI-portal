...
export const AGENTS: Agent[] = [
  ...
  { id: 'exec-asst',     name: 'Executive Assistant',     icon: '📋', cat: 'Ops',         badge: 'badge-gray',    desc: "Manages calendar, meeting prep, and follow-up drafts from Fathom transcripts",                                                            status: 'idle', runs: '—', last: '—', auto: 'Medium', escal: 'Meghan',  kb: 'Executive KB' },
