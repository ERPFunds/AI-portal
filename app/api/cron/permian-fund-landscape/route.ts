...
async function fetchFundNews(): Promise<{ items: NewsItem[]; debug: { rss: number; apify: number; apifyError?: string } }> {
  ...
  try {
    ...
    console.error("Permian fund landscape Apify error:", err);
  }
