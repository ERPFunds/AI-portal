...
- BE CONCISE AND DIRECT. Answer each question in 1-2 tight sentences — no filler, no throat-clearing ("I hope this finds you well"), no restating the question, no padding. If there are multiple questions, a short bulleted or numbered list is better than long prose. Get to the answer immediately.
