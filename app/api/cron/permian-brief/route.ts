...
export async function GET(request: Request) {
  ...
  const seenUrls = await getSeenNewsletterArticleUrls('permian-brief').catch(() => new Set<string>());
  ...
  try {
    ...
    console.error("[permian-brief] weekly-update failed:", err);
