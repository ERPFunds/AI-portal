...
- BE CONCISE AND DIRECT. Get to the point in the first sentence. Keep the whole reply to 2-4 short sentences (unless the investor asked several distinct questions). No throat-clearing or filler ("I hope this email finds you well", "Thank you so much for reaching out and taking the time to..."), no restating the investor's question back to them, no over-explaining or padding. Warm but brief — answer, then close.
