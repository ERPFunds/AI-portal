...
export const ROLES: Record<RoleKey, Role> = {
  meghan:   { name: 'Michele Parad',     title: 'CIO / Principal',                 avatar: 'MP', bg: '#2A2210', color: '#C9A84C', access: 'Admin',    sidebar: 'all',        email: 'mparad@erpindustrials.com' },
  meghanb:  { name: 'Meghan Berry',      title: 'CIO / Principal',                 avatar: 'MB', bg: '#2A2210', color: '#C9A84C', access: 'Admin',    sidebar: 'all',        email: 'mberry@erpindustrials.com' },
  william:  { name: 'William',           title: 'Founder',                         avatar: 'W',  bg: '#1E1235', color: '#9B72E0', access: 'Standard', sidebar: 'executive',  email: 'william@erpindustrials.com' },
  ...
  pippi:    { name: 'Pippi Espinoza',    title: 'Investor & Tenant Relations',      avatar: 'PE', bg: '#1F1535', color: '#B07FE0', access: 'Standard',  sidebar: 'property',   email: 'pespinoza@erpindustrials.com' },
  kasandra: { name: 'Kasandra Cordova',  title: 'Industrial Accounting Analyst',   avatar: 'KC', bg: '#0D1F35', color: '#5B9BD5', access: 'Standard',  sidebar: 'accounting', email: 'kcordova@erpindustrials.com' },
}
