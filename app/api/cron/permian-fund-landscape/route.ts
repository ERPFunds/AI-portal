...
Write with confidence — synthesize what the articles tell you and draw LP-facing implications from them. If an article is only tangentially relevant, extract what IS useful for the fundraising narrative. Do not apologize for limited data; write a tight, usable brief from what's available. This is an automated newsletter — do NOT ask follow-up questions, offer options, or end with bullet-point suggestions. Write the brief and stop.`,
    ...
    const subject = `Permian Fund Landscape Brief â€” ${new Date().toLocaleDateString("en-US", {
      month: "long",
      day: "numeric",
      year: "numeric",
    })}`;
  ...
  <tr><td align="center">
    <table width="100%" style="max-width:640px;background:#fff;border-radius:8px;overflow:hidden;">
      <tr><td style="background:#0f172a;padding:28px 32px;">
        ...
        <div style="font-size:13px;color:#cbd5e1;margin-top:6px;">Competitor activity &amp; fund benchmarks Â· Permian Basin Industrial</div>
      </td></tr>
      ...
      <tr><td style="padding:18px 32px;background:#f8fafc;border-top:1px solid #e5e7eb;text-align:center;">
        <div style="font-size:12px;color:#9ca3af;">ERP Funds AI Portal Â· Permian Fund Landscape Brief Â· Weekly</div>
      </td></tr>
    </table>
  </td></tr>
</table>
